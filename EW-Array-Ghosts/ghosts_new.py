...
class T_ghost():
    ...
    def extrapolation_function(self,baseline=np.array([0,1]),true_sky_model=np.array([[1,0,0],[0.2,1,0]]),cal_sky_model=np.array([[1,0,0]]),Phi=np.array([[0,3,5],[-3,0,2],[-5,-2,0]]),image_s=3,s=1,resolution=100,kernel=True,type_plot="GT-1"):
        ...
        #print(image_s)
        #print(s)
        im = ax.imshow(zz_f.real,extent=[-s_old*image_s,s_old*image_s,-s_old*image_s,s_old*image_s])
...
if __name__ == "__main__":
   ...
   t.extrapolation_function(baseline=np.array([0,1]),true_sky_model=np.array([[1,0,0],[0.2,1,0]]),cal_sky_model=np.array([[1,0,0]]),Phi=np.array([[0,3,5],[-3,0,2],[-5,-2,0]]),image_s=3,s=1,resolution=100,kernel=True,type_plot="R")
