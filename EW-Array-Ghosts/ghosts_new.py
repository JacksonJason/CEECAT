...
class T_ghost():
    ...
    def theory_g(self,baseline=np.array([0,1]),true_sky_model=np.array([[1,0,0,0.1]]),cal_sky_model=np.array([[1,0,0]]),Phi=np.array([[0,3,5],[-3,0,2],[-5,-2,0]]),image_s=3,s=1,resolution=100):
        ...
        return(g_pq.real[int(g_pq.shape[0]/2),:]),B
    ...
    def extrapolation_function(self,baseline=np.array([0,1]),true_sky_model=np.array([[1,0,0],[0.2,1,0]]),cal_sky_model=np.array([[1,0,0]]),Phi=np.array([[0,3,5],[-3,0,2],[-5,-2,0]]),image_s=3,s=1,resolution=100,kernel=True,type_plot="GT-1"):
        ...
        plt.show()
        print(np.max(g_pq.real))
        return(g_pq.real[int(g_pq.shape[0]/2),:])
...
if __name__ == "__main__":
   ...
   g1,B=t.theory_g(baseline=np.array([0,1]),true_sky_model=np.array([[1,0,0,0.5]]),cal_sky_model=np.array([[1,0,0]]),Phi=np.array([[0,3,5],[-3,0,2],[-5,-2,0]]),image_s=3,s=1,resolution=100)
   g2=t.extrapolation_function(baseline=np.array([0,1]),true_sky_model=np.array([[1,0,0,0.5]]),cal_sky_model=np.array([[1,0,0]]),Phi=np.array([[0,3,5],[-3,0,2],[-5,-2,0]]),image_s=3,s=1,resolution=100)
   plt.plot(g1,"r")
   plt.plot(g2,"b")
   # plt.plot((g1)**(-1),"g")
   # plt.plot(g2,"b")
